...
void main() {
  group("leftSubcurveAt", () {
    test("quadratic leftSubcurveAt", () {
      ...
      expect(result1, new TypeMatcher<BDQuadraticBezier>());
      final curve1 = result1 as BDQuadraticBezier;
      ...
      expect(result2, new TypeMatcher<BDQuadraticBezier>());
      final curve2 = result2 as BDQuadraticBezier;
      ...
      expect(result3, new TypeMatcher<BDQuadraticBezier>());
      final curve3 = result3 as BDQuadraticBezier;
    ...
    test("cubic leftSubcurveAt", () {
      ...
      expect(curve3.points[3], closeToVector(new Vector2(59.400001525878906, 69.30000305175781)));
    });
    ...
    test("quadratic leftSubcurveAt, t > 1.0", () {
      ...
      final splitCurve = result as BDQuadraticBezier;
  ...
  group("subcurveBetween", () {
    ...
    test("quadratic subcurveBetween", () {
      ...
      expect(result1, new TypeMatcher<BDQuadraticBezier>());
      final curve1 = result1 as BDQuadraticBezier;
      expect(curve1.points[0], closeToVector(new Vector2(20.399999618530273, 61.400001525878906)));
      expect(curve1.points[1], closeToVector(new Vector2(18.700000762939453, 64.69999694824219)));
      expect(curve1.points[2], closeToVector(new Vector2(17.350000381469727, 69.3499984741211)));
    });
  });
  ...
  group("simpleSubcurves", () {
    test("cubic simpleSubcurves", () {
      ...
      expect(result[0].points, closeToVectorList([
        new Vector2(105.0, -70.0),
      ...
      expect(result[1].points, closeToVectorList([
        new Vector2(101.06576538085938, -61.580623626708984),
      ...
      expect(result[2].points, closeToVectorList([
        new Vector2(59.170291900634766, 16.937719345092773),
      ...
      expect(result[3].points, closeToVectorList([
      ...
      expect(result[4].points, closeToVectorList([
        new Vector2(57.70787048339844, 77.77613830566406),
