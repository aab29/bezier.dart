...
void main() {
  group("pointAt", () {
    test("quadratic pointAt", () {
      ...
      expect(curve.pointAt(0.33333333),
          closeToVector(new Vector2(37.22222137451172, 55.5555534362793)));
      expect(curve.pointAt(0.85),
          closeToVector(new Vector2(28.912500381469727, 82.25)));
    });
    ...
    test("cubic pointAt", () {
      ...
      expect(curve.pointAt(0.33333333),
          closeToVector(new Vector2(40.185184478759766, 52.592594146728516)));
      expect(curve.pointAt(0.85),
          closeToVector(new Vector2(21.389999389648438, 61.11687469482422)));
    });
  });
  ...
  group("hullPointsAt", () {
    ...
    test("cubic hullPointsAt, second test", () {
      ...
      expect(hull2[7],
          closeToVector(new Vector2(38.79999923706055, 43.599998474121094)));
      expect(hull2[8],
          closeToVector(new Vector2(20.399999618530273, 61.400001525878906)));
      expect(hull2[9],
          closeToVector(new Vector2(24.079999923706055, 57.84000015258789)));
    });
  ...
  group("derivativeAt", () {
    test("quadratic derivativeAt", () {
      ...
      expect(curve.derivativeAt(0.33333),
          closeToVector(new Vector2(43.33409881591797, 103.33399963378906)));
      expect(curve.derivativeAt(0.5), closeToVector(new Vector2(5.0, 70.0)));
      expect(curve.derivativeAt(0.6827),
          closeToVector(new Vector2(-37.020999908447266, 33.459999084472656)));
      ...
      expect(
          curve.derivativeAt(1.0), closeToVector(new Vector2(-110.0, -30.0)));
    });
    ...
    test("cubic derivativeAt", () {
      ...
      expect(curve.derivativeAt(0.1),
          closeToVector(new Vector2(121.19999694824219, 167.85000610351562)));
      expect(
          curve.derivativeAt(0.25), closeToVector(new Vector2(48.75, 70.3125)));
      expect(curve.derivativeAt(0.33333),
          closeToVector(new Vector2(16.66783332824707, 33.33456802368164)));
      expect(curve.derivativeAt(0.5), closeToVector(new Vector2(-30.0, -3.75)));
      expect(curve.derivativeAt(0.6827),
          closeToVector(new Vector2(-54.34769821166992, 12.08817195892334)));
      expect(curve.derivativeAt(0.75),
          closeToVector(new Vector2(-56.25, 32.8125)));
      expect(curve.derivativeAt(0.9),
          closeToVector(new Vector2(-46.79999923706055, 107.8499984741211)));
    ...
    test("quadratic derivativeAt, specified cachedFirstOrderDerivativePoints",
      ...
      expect(
          ...
          closeToVector(new Vector2(120.0, 170.0)));
      expect(
          curve.derivativeAt(0.1,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(97.0, 150.0)));
      expect(
          curve.derivativeAt(0.25,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(62.5, 120.0)));
      expect(
      ...
      expect(
          curve.derivativeAt(0.5,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(5.0, 70.0)));
      expect(
      ...
      expect(
          curve.derivativeAt(0.75,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-52.5, 20.0)));
      expect(
          curve.derivativeAt(0.9,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-87.0, -10.0)));
      expect(
          curve.derivativeAt(1.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-110.0, -30.0)));
    });
    ...
    test("cubic derivativeAt, specified cachedFirstOrderDerivativePoints", () {
      ...
      expect(
          curve.derivativeAt(0.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(180.0, 255.0)));
      expect(
          curve.derivativeAt(0.1,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(121.19999694824219, 167.85000610351562)));
      expect(
          curve.derivativeAt(0.25,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(48.75, 70.3125)));
      expect(
          curve.derivativeAt(0.33333,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(16.66783332824707, 33.33456802368164)));
      expect(
          curve.derivativeAt(0.5,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-30.0, -3.75)));
      expect(
          curve.derivativeAt(0.6827,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-54.34769821166992, 12.08817195892334)));
      ...
      expect(
          curve.derivativeAt(1.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-30.0, 180.0)));
    });
  });
  ...
  group("normalAt", () {
    test("cubic normalAt", () {
      ...
      expect(curve.normalAt(0.5),
          closeToVector(new Vector2(0.12403473258018494, -0.9922778606414795)));
      expect(curve.normalAt(0.23),
          closeToVector(new Vector2(-0.8163508176803589, 0.5775563716888428)));
      expect(
          curve.normalAt(0.69),
          closeToVector(
              new Vector2(-0.24693183600902557, -0.9690328240394592)));
      expect(curve.normalAt(0.0),
          closeToVector(new Vector2(-0.8169678449630737, 0.5766832232475281)));
      expect(curve.normalAt(1.0),
          closeToVector(new Vector2(-0.986393928527832, -0.16439898312091827)));
    });
    ...
    test("quadratic normalAt", () {
      ...
      expect(curve.normalAt(0.5),
          closeToVector(new Vector2(-0.9974586963653564, 0.07124704867601395)));
      expect(curve.normalAt(0.23),
          closeToVector(new Vector2(-0.9185916185379028, 0.3952080309391022)));
      expect(
          curve.normalAt(0.69),
          closeToVector(
              new Vector2(-0.9987242221832275, -0.05049728974699974)));
      expect(curve.normalAt(0.0),
          closeToVector(new Vector2(-0.5547001957893372, 0.8320503234863281)));
      expect(curve.normalAt(1.0),
          closeToVector(new Vector2(-0.986393928527832, -0.16439898312091827)));
    });
    ...
    test("cubic normalAt, specified cachedFirstOrderDerivativePoints", () {
      ...
      expect(
          ...
          closeToVector(new Vector2(-0.9578262567520142, 0.2873478829860687)));
      expect(
          curve.normalAt(0.18, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.6621309518814087, 0.7493881583213806)));
      expect(
          curve.normalAt(0.375, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(0.29084232449531555, 0.9567710161209106)));
      expect(
          curve.normalAt(0.5, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(0.5057194828987122, 0.862697958946228)));
      expect(
          curve.normalAt(0.625, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(0.4644697606563568, 0.8855890035629272)));
      expect(
          curve.normalAt(0.82, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.5096653699874878, 0.8603727221488953)));
      expect(
          curve.normalAt(1.0, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.9805806875228882, 0.1961161345243454)));
    });

    test("quadratic normalAt, specified cachedFirstOrderDerivativePoints", () {
      final curve = new QuadraticBezier([
        new Vector2(130.0, -40.0),
        new Vector2(110.0, 85.0),
        new Vector2(-45.0, 170.0)
      ]);

      final cachedPoints = <Vector2>[
        new Vector2(-40.0, 250.0),
        new Vector2(-310.0, 170.0),
      ];
      ...
      expect(
          curve.normalAt(0.0, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.9874406456947327, -0.157990500330925)));
      expect(
          curve.normalAt(0.18, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.936002254486084, -0.35199403762817383)));
      expect(
          curve.normalAt(0.375, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.8414890170097351, -0.5402742028236389)));
      expect(
          curve.normalAt(0.5, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.7682212591171265, -0.6401844024658203)));
      expect(
          curve.normalAt(0.625, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.6918114423751831, -0.7220782041549683)));
      expect(
          curve.normalAt(0.82, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.5764377117156982, -0.8171411156654358)));
      expect(
          curve.normalAt(1.0, cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(
              new Vector2(-0.48083260655403137, -0.8768123984336853)));
    });
  });
  ...
  group("offsetPointAt", () {
    test("cubic offsetPointAt", () {
      ...
      expect(pointA,
          closeToVector(new Vector2(37.30337142944336, 62.81601333618164)));

      final pointB = curve.offsetPointAt(0.85, 10.0);
      expect(pointB,
          closeToVector(new Vector2(34.19104766845703, 39.19478988647461)));

      final pointC = curve.offsetPointAt(0.0, 16.0);
      expect(pointC,
          closeToVector(new Vector2(-3.0714855194091797, 19.226932525634766)));

      final pointD = curve.offsetPointAt(1.0, 1.0);
      expect(pointD,
          closeToVector(new Vector2(25.980581283569336, 20.196115493774414)));
    });
    ...
    test("quadratic offsetPointAt", () {
      ...
      expect(pointA,
          closeToVector(new Vector2(48.78436279296875, 62.17439651489258)));

      final pointB = curve.offsetPointAt(0.15, 5.0);
      expect(pointB,
          closeToVector(new Vector2(31.915807723999023, 61.86527633666992)));

      final pointC = curve.offsetPointAt(0.0, 1.0);
      expect(pointC,
          closeToVector(new Vector2(15.707106590270996, 70.70710754394531)));

      final pointD = curve.offsetPointAt(1.0, 8.0);
      expect(pointD,
          closeToVector(new Vector2(62.01771926879883, 95.53215026855469)));
    });
    ...
    test("quadratic offsetPointAt, negative distance", () {
      ...
      expect(curve.offsetPointAt(0.5, -1.0),
          closeToVector(new Vector2(50.0, 49.0)));
      expect(curve.offsetPointAt(0.5, -50.0),
          closeToVector(new Vector2(50.0, 0.0)));
      expect(curve.offsetPointAt(0.75, -15.0),
          closeToVector(new Vector2(64.39340209960938, 26.89339828491211)));
      expect(curve.offsetPointAt(0.273, -8.2),
          closeToVector(new Vector2(32.81229019165039, 33.62339401245117)));
      expect(curve.offsetPointAt(1.0, -50.0),
          closeToVector(new Vector2(55.27864074707031, -22.360679626464844)));
      expect(curve.offsetPointAt(0.0, -100.0),
          closeToVector(new Vector2(89.44271850585938, -44.72135925292969)));
    });
    ...
    test("cubic offsetPointAt, negativeDistance", () {
      ...
      expect(curve.offsetPointAt(0.5, -1.0),
          closeToVector(new Vector2(50.164398193359375, 44.736392974853516)));
      expect(curve.offsetPointAt(0.5, -50.0),
          closeToVector(new Vector2(58.219947814941406, 93.06969451904297)));
      expect(curve.offsetPointAt(0.75, -15.0),
          closeToVector(new Vector2(28.88807487487793, 62.56289291381836)));
      expect(curve.offsetPointAt(0.273, -8.2),
          closeToVector(new Vector2(77.95957946777344, 50.75044250488281)));
      expect(curve.offsetPointAt(1.0, -50.0),
          closeToVector(new Vector2(109.8058090209961, 50.97096633911133)));
      expect(curve.offsetPointAt(0.0, -100.0),
          closeToVector(new Vector2(-37.139068603515625, 7.1523284912109375)));
    });
    ...
    test("quadratic offsetPointAt, specified cachedFirstOrderDerivativePoints",
      ...
      expect(
          curve.offsetPointAt(0.0, 10.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-8.9442720413208, 4.4721360206604)));
      expect(
          curve.offsetPointAt(0.25, 40.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-3.284270763397217, 65.78427124023438)));
      expect(
          curve.offsetPointAt(0.5, 24.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(50.0, 74.0)));
      expect(
          curve.offsetPointAt(0.5, -30.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(50.0, 20.0)));
      expect(
          curve.offsetPointAt(0.55, -30.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(49.11651611328125, 20.082578659057617)));
      expect(
          curve.offsetPointAt(0.83, 40.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(114.88368225097656, 52.374305725097656)));
      expect(
          curve.offsetPointAt(1.0, -10.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(91.05572509765625, -4.4721360206604)));
    });
    ...
    test("cubic offsetPointAt, specified cachedFirstOrderDerivativePoints", () {
      ...
      expect(
          curve.offsetPointAt(0.0, 10.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(3.713906764984131, 109.2847671508789)));
      expect(
          curve.offsetPointAt(0.25, 40.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(125.29229736328125, 57.936668395996094)));
      expect(
          curve.offsetPointAt(0.5, 24.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(46.05442428588867, 20.07654571533203)));
      expect(
          curve.offsetPointAt(0.5, -30.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(54.931968688964844, 73.3418197631836)));
      expect(
          curve.offsetPointAt(0.55, -30.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(46.82734680175781, 75.10584259033203)));
      expect(
          curve.offsetPointAt(0.83, 40.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(-0.15876483917236328, 108.22217559814453)));
      expect(
          curve.offsetPointAt(1.0, -10.0,
              cachedFirstOrderDerivativePoints: cachedPoints),
          closeToVector(new Vector2(101.9611587524414, 90.1941909790039)));
    });
  });
  ...
  group("positionLookUpTable", () {
    ...
    test("cubic positionLookUpTable, default intervalsCount", () {
      ...
      expect(table[0], closeToVector(new Vector2(0.0, 0.0)));
      expect(table[1],
          closeToVector(new Vector2(2.9407999515533447, 5.763200283050537)));
      expect(table[20],
          closeToVector(new Vector2(42.400001525878906, 49.60000228881836)));
      expect(table[25], closeToVector(new Vector2(50.0, 50.0)));
      expect(table[30],
          closeToVector(new Vector2(57.599998474121094, 50.39999771118164)));
      expect(table[49],
          closeToVector(new Vector2(97.05919647216797, 94.23680114746094)));
